...
def set_args():
    ...
    parser.add_argument('--model_dir', default="/home/fg21/llm-master/save/epoch-1-step-198", type=str, help='')
...
if __name__ == '__main__':
    args = set_args()
    base_model = ModelMode[args.mode]["model"].from_pretrained(args.ori_model_dir)
